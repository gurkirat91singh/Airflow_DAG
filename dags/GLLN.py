...
SPARK_PARAMS = (
    ...
    "--py-files s3://gsingh-pyspark-poc/files/app.zip,s3://gsingh-pyspark-poc/deps/pydeps.zip"
...
with DAG(
    dag_id="GLLN",  # MUST match stgwe.stg_job.job_name
    ...
    start_log >> two_step_step1 
    two_step_step1  >> [end_ok, end_fail]
